//
//  CustomInputAccessroyView.swift
//  dustinChat
//
...
protocol CustomInputAccessroyViewDelegate: class {
    func inputView(_ inputView: CustomInputAccessroyView, wantsTosend message : String)
}


class CustomInputAccessroyView: UIView {
    //MARK: - Properties
    
    weak var delegate: CustomInputAccessroyViewDelegate?
    ...
    override init(frame: CGRect) {
        ...
        placeholderLabel.anchor(left:messageInputTextView.leftAnchor , paddingTop:  4)
        placeholderLabel.centerY(inView: messageInputTextView)
        
        
        //hidden placeholder lable
